...
export default function HomePage() {
  ...
  const selectedOpponentObj =
    VOICE_PARTNERS.find((p) => p.key === debateOpponent) || VOICE_PARTNERS[3];
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400 mt-1.5 leading-relaxed">
                    Multi-persona room with AI peers & moderator. Practice natural turn-taking &
                    group dynamics.
                  </p>
                </div>
              </button>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400 mt-1.5 leading-relaxed">
                    Direct argument & counter-rebuttal challenge with 1 AI opponent. Sharpen logic
                    under pressure.
                  </p>
                </div>
              </button>
        ...
        {step === 3 && (
          <div className="space-y-5 my-auto">
            <div className="text-center space-y-1">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">
                {mode === "debate"
                  ? "Choose 1 AI Opponent for your 1:1 debate"
                  : "Choose 2 or more AI discussion partners"}
              </p>
            </div>
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      <span className="text-sm font-extrabold text-slate-900 dark:text-white">
                        {selectedOpponentObj.name}
                      </span>
                      <span className="text-sm">{selectedOpponentObj.flag}</span>
                      <span className="text-xs font-semibold text-[#F25C40]">
                        ({selectedOpponentObj.accent})
                      </span>
                    </div>
                    <p className="text-xs font-bold text-slate-700 dark:text-slate-300 mt-0.5">
                      {selectedOpponentObj.title}
                    </p>
                    <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-0.5">
                      {selectedOpponentObj.style}
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <span className="text-[11px] font-semibold text-[#F25C40] block truncate">
                          {p.title}
                        </span>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                {DIFFICULTIES.map((d) => {
                  ...
                  return (
                    ...
                    >
                      <p
                        className={`text-xs font-bold ${active ? "text-white" : "text-slate-900 dark:text-white"}`}
                      >
                        {d.label}
                      </p>
                      <p
                        className={`text-[11px] mt-0.5 ${active ? "text-white/80" : "text-slate-400"}`}
                      >
                        {d.desc}
                      </p>
                    </button>
              ...
              {creating ? (
                ...
                <>
                  <span>
                    Launch{" "}
                    {mode === "debate"
                      ? `1:1 Debate (${selectedOpponentObj.name})`
                      : `GD (${gdPartners.length} Partners)`}{" "}
                    ({duration}m)
                  </span>
                  <ArrowRight size={16} />
                </>
