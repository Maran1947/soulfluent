...
class _LessonActivityWidgetState extends State<LessonActivityWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    final phrases = widget.node.phrasesA.isNotEmpty
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                const Icon(Icons.menu_book_rounded, size: 14, color: AppTheme.primary),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    const Icon(Icons.lightbulb_outline_rounded, size: 18, color: Color(0xFFEAB308)),
